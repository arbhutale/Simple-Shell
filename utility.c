...
extern void display_help(void){
    ...
    printf("myhelp\t\t\t Lists the help menu.\n");
    printf("mydir <directory>\t\t Lists the contents of the directory\n");
    printf("myenviron\t\t\t Lists all the environment strings..\n");
    printf("myecho <comment>\t\t Displays comment on the command line followed by a newline.\n");
	printf("mycd <path>\t\t Changes the working directory to the specified path.\n");
    printf("myclr\t\t\t Clears the screen.\n");
    printf("mypause\t\t\t Pauses operation of the shell until the ENTER key is hit.\n");
    printf("myquit\t\t\t Quits the shell.\n\n\n");
